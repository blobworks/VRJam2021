// TODO: reflection probes
// TODO: light probes

Shader "DHShaders/Cartoon/CartoonUbershader"
{
    Properties
    {
		[Space()]
    ...
    SubShader
    {
		...
		CGPROGRAM
		#pragma surface surf Cartoon nolightmap fullforwardshadows addshadow
		#pragma target 3.0
		...
		{
			o.Albedo = tex2D(_MainTex, IN.uv_MainTex).rgb * _Color * IN.color.rgb * unity_ColorSpaceDouble.x;
